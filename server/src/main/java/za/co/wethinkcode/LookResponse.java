...
public class LookResponse extends Response {
    ...
    /**
     * Constructor for za.co.wethinkcode.LookResponse, from extending response;
    ...
    private ArrayList<HashMap<String,String>> setObjects() {
        ...
        for (Object key : robotData.keySet()) {
            ...
            tempData.put("za.co.wethinkcode.Direction",checkDirectionType(tempArray.get(1)));
     ...
     * za.co.wethinkcode.Robot, za.co.wethinkcode.Obstacle, za.co.wethinkcode.Pit or za.co.wethinkcode.Mine
     * */
    private String checkObjectType(Object value) {
        if (value.getClass() == SniperRobot.class ||
            ...
            return "za.co.wethinkcode.Robot";
        } else if (value.getClass() == Obstacle.class) {
            return "za.co.wethinkcode.Obstacle";
        } else if (value.getClass() == Pit.class) {
            return "za.co.wethinkcode.Pit";
        } else if (value.getClass() == Mine.class) {
            return "za.co.wethinkcode.Mine";
        }
        return "za.co.wethinkcode.Robot";
    }
