...
/**
 * A basic interface that wraps the expected za.co.wethinkcode.Robot Worlds API so that we can easily connect to and send requests to the server.
 */
public interface RobotWorldClient {
    /**
     * Connects to the za.co.wethinkcode.Robot Worlds server on specified ip address and port
